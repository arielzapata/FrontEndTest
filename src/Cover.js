...
function Cover(props) {  
  const HeaderLineOne = { T: "90px", H: "92px", E: "100px" }
  const HeaderLineTwo = { V: "80px", A: "90px", N: "100px", I:"110px", S: "120px", H: "130px", I2: "140px", N2: "150px", G: "160px" }
  const HeaderLineThree = { F: "80px", U: "90px", T: "100px", U2: "110px", R: "120px", I: "130px", S: "140px", T2: "150px"}
  ...
  return (
    <div>
      <MainContainer>
        ...
        <Title>         
          { StairWords(HeaderLineOne) }      
          { StairWords(HeaderLineTwo) }
          { StairWords(HeaderLineThree) }        
        </Title>
